export const BROKERS = [
  { id: 'ibkr', name: 'InteractiveBrokers', logo: '/logos/ibkr.svg', format: 'CSV',
  ...
  { id: 'flatex', name: 'Flatex', logo: '/logos/flatex.svg', format: 'PDF + CSV',
    desc: '2 Dateien nötig: 1) Kontoumsätze der Verrechnungskonten (bei mehreren Depots je Depot eine Datei) unter Flatex Classic > Konto & Depot > Konto auswählen, Jahreszeitraum auswählen > Übernehmen > dann Klick auf 3 Punkte > Export CSV. 2) Erträgnisaufstellung beantragen unter Flatex Classic > Service, Steuern > Steuerbescheinigungen > Depot auswählen > Steuerjahr auswählen, dann „Steuerbescheinigung beantragen" → wird im Postfach bereitgestellt. Hinweis: Flatex liefert auch bei mehreren Depots nur eine Erträgnisaufstellung.' },
]
...
export const FAQS = [
  ...
  { q: 'Mit welchen Banken funktioniert das?',
    a: 'Derzeit funktioniert Wertstapel mit Dokumenten von InteractiveBrokers, allen Sparkassen, Comdirect und flatexDEGIRO. Weitere Banken befinden sich in Entwicklung bzw. können auf Wunsch eingebunden werden. Reichen Sie ein anonymisiertes Muster-PDF ein – wir prüfen die Kompatibilität kostenfrei: muster@wertstapel.de' },
  { q: 'Welche Dokumente muss ich hochladen?',
    a: 'Hier findest Du die relevanten Dokumente bei Deiner Bank / Deinem Broker:\n– InteractiveBrokers: Reports & Statements > Statements > Activity Statement. Ganzes Jahr und mit Details ("with Securities and Futures Breakdown") auswählen. Als CSV herunterladen.\n– Sparkassen: Nachrichten > Postfach > Filter „Wertpapierdokumente", Datum und Depotinhaber setzen > alle PDFs herunterladen. Alternativ kann Ihr Bankberater eine aggregierte PDF mit allen Transaktionen zur Verfügung stellen.\n– Comdirect: Depot > Abrechnungsdatum > Zeitraum auswählen > unten „CSV exportieren"\n– Flatex: 2 Dateien nötig: 1) Kontoumsätze der Verrechnungskonten (bei mehreren Depots je Depot eine Datei) unter Flatex Classic > Konto & Depot > Konto auswählen, Jahreszeitraum auswählen > Übernehmen > dann Klick auf 3 Punkte > Export CSV 2) Erträgnisaufstellung beantragen unter Flatex Classic > Service, Steuern > Steuerbescheinigungen > Depot auswählen > Steuerjahr auswählen, dann „Steuerbescheinigung beantragen" → wird im Postfach bereitgestellt. Hinweis: Flatex liefert auch bei mehreren Depots nur eine Erträgnisaufstellung.' },
